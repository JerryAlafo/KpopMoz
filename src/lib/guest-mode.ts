export const GUEST_MODE_COOKIE = "kpopmoz_guest";
export const LOGIN_REQUIRED_EVENT = "kpopmoz:login-required";
export const GUEST_MODE_CHANGED_EVENT = "kpopmoz:guest-mode-changed";
